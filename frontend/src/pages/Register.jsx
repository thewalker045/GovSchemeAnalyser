...
function Register() {
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    try {
      ...
      // Save token and user, go straight to dashboard
  ...
  const features = [
    ...
    {
      title: "Secure Access",
      text: "Protected access to welfare services with encrypted authentication.",
      ...
      <div className="min-h-screen flex flex-col lg:flex-row relative z-10">
        ...
        >
          <div>
            ...
            <p className="text-gray-500 mt-2">Create your citizen account for digital welfare access</p>
          </div>
          ...
          >
            ...
            <div className="mt-7 p-4 rounded-xl bg-gradient-to-r from-cyan-50 via-violet-50 to-fuchsia-50 border border-violet-100">
              <p className="text-xs text-gray-400 leading-relaxed text-center">
                Your details are protected with secure encrypted access.
              </p>
            </div>
          </motion.div>
        </motion.div>
