          ...
          >
              ...
              <>
                ...
                <div className="text-center mb-7">
                  ...
                  <p className="text-gray-500 text-sm mt-2">
                    ...
                    <span className="text-cyan-500 font-medium">{email}</span>
                  </p>
                </div>
                  ...
                  <div className="flex justify-center gap-2 sm:gap-3">
                    {otp.map((digit, index) => (
                      <input
                        ...
                        className={`w-11 h-13 sm:w-12 sm:h-14 text-center text-xl font-bold rounded-xl border-2 transition-all focus:outline-none focus:ring-2 focus:ring-cyan-400 text-gray-800 ${
                          digit
                ...
                <div className="flex justify-between mt-5 text-sm">
                  <span
                    ...
                    className="text-cyan-500 hover:text-cyan-600 cursor-pointer transition font-medium"
                  >
                    ← Change Email
                  </span>
                  <span
                    ...
                    className={`transition font-medium ${
                      resendCooldown
                        ...
                        : "text-violet-500 hover:text-violet-600 cursor-pointer"
                    }`}
                  >
            ...
            <div className="mt-7 p-4 rounded-xl bg-gradient-to-r from-cyan-50 via-violet-50 to-fuchsia-50 border border-violet-100">
              <p className="text-xs text-gray-400 leading-relaxed text-center">
                Your information is protected with secure digital access and OTP
                verification.
              </p>
            </div>
          </motion.div>
